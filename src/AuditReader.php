...
class AuditReader
{
    ...
    */
    public function findEntityChangesSinceRevision(string $className, $project, int $revision, bool $validated = true,
    	bool $filterDeleted = true, bool $filterCreated=true, ?int $toRevision=null) {
